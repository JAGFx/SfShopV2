<?php
	...
	class MarqueController extends Controller {
		...
		public function indexAction() {
			...
			return $this->render(
				'sil21AdminBundle:Marque:index.html.twig', [
										 'marques' => $marques,
									 ]
			);
		}
		...
		public function newAction( Request $request ) {
			...
			return $this->render(
				'sil21AdminBundle:Marque:new.html.twig', [
									       'Marque' => $marque,
		...
		public function showAction( Marque $marque ) {
			...
			return $this->render(
				'sil21AdminBundle:Marque:show.html.twig', [
										'marque'      => $marque,
		...
		public function editAction( Request $request, Marque $marque ) {
			...
			return $this->render(
				'sil21AdminBundle:Marque:edit.html.twig', [
										'marque'      => $marque,
