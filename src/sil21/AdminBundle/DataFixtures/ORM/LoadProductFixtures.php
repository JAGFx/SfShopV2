<?php
	...
	class LoadProduct implements FixtureInterface, OrderedFixtureInterface, ContainerAwareInterface {
		...
		public function load( ObjectManager $manager ) {
			...
			foreach ( $products as $productBDD ) {
				...
				/**
				 * $this->container->getParameter( 'web_dir' ) . $this->container->getParameter(
				 * 'path_image_product'
				 * ) . '/' .
				 */
				...
				$product = new Product();
				$product
					->setId( $productBDD[ 'name' ])
					->setCategory( $category )
					->setBrand( $marque )
					->setName( $productBDD[ 'name' ] )
					->setImage( $file )
					->setPrice( $productBDD[ 'price' ] )
					->setSavedAmount( $productBDD[ 'saved_amount' ] )
